					...
					<a href="#"><img src="images/sidearea-opener.png" width="50%" id="dai">
						<div id="myNav" class="overlay-v1">
							...
							<div class="overlay-content-v1">
								...
								<div class="hinhanh">
									<img class="hinh" src="images/1-1.jpg" alt="">
									<img class="hinh" src="images/1-2.jpg" alt="">
									<img class="hinh" src="images/1-3.jpg" alt="">
									<img class="hinh" src="images/1-4.jpg" alt="">
									<img class="hinh" src="images/1-5.jpg" alt="">
									<img class="hinh" src="images/1-6.jpg" alt="">
								</div>
