			...
			<div class="khung">
					...
					<div class="swiper-wrapper">
							...
							<div class="vo">
								<div class="iner">
									<div class="hinhanh">
										...
										<img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/1.jpg" alt="">
									</div>
									<div class="text">
										<div class="out-text" >
											<div class="in-text">
						...
						<div class="swiper-slide">
							<div class="vo">
								<div class="iner">
									<div class="hinhanh">
										<img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/2.jpg" alt="">
									</div>
									<div class="text">
										<div class="out-text">
											<div class="in-text">
							...
							<div class="vo">
								<div class="iner">
									<div class="hinhanh">
										...
										<img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/3.jpg" alt="">
									</div>
									<div class="text">
										<div class="out-text">
											<div class="in-text">
							...
							<div class="vo">
								<div class="iner">
									<div class="hinhanh">
										...
										<img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/4.jpg" alt="">
									</div>
									<div class="text">
										<div class="out-text">
											<div class="in-text">
						...
						<div class="swiper-slide">
							<div class="vo">
								<div class="iner">
									<div class="hinhanh">
										<img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/5.jpg" alt="">
									</div>
									<div class="text">
										<div class="out-text">
											<div class="in-text">
						...
						<div class="swiper-slide">
							<div class="vo">
								<div class="iner">
									<div class="hinhanh">
										<span class="sale">SALE</span>
										<img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/6.jpg" alt="">
									</div>
									<div class="text">
										<div class="out-text">
											<div class="in-text">
				...
				<div class="thongtin" id="tintuc">
					...
					<div class="lopcontent">
						<div class="chuaanh">
							<a href="#"><img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/1-1.jpg" alt=""></a>
				...
				<div class="thongtin" id="tintuc1">
					...
					<div class="lopcontent">
						<div class="chuaanh">
							<a href="#"><img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/2-1.jpg" alt=""></a>
				...
				<div class="thongtin" id="tintuc2">					
					<div class="lopcontent">
						<div class="chuaanh">
							<a href="#"><img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/3-1.jpg" alt=""></a>
				...
				<div class="thongtin" id="tintuc3">					
					<div class="lopcontent">
						<div class="chuaanh">
							<a href="#"><img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/4-1.jpg" alt=""></a>
							<span class="sale1">sale</span>
						</div>
						<div class="chuatintuc">
				...
				<div class="thongtin" id="tintuc4">					
					<div class="lopcontent">
						<div class="chuaanh">
							<a href="#"><img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/5-1.jpg" alt=""></a>
				...
				<div class="thongtin" id="tintuc5">					
					<div class="lopcontent">
						<div class="chuaanh">
							<a href="#"><img src="<?php bloginfo('template_directory'); ?> /templates/module3/image/6-1.jpg" alt=""></a>
							<span class="sale1">Sale</span>
						</div>
						<div class="chuatintuc">
